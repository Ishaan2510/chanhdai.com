export const registryConfig = {
   ...
   * @example "@ishaan" - Users can install components with: `npx shadcn add @ishaan/component`
   * @see https://ui.shadcn.com/docs/registry/namespace#overview
   */
  namespace: process.env.NEXT_PUBLIC_REGISTRY_NAMESPACE || "@ishaan",
  /**
   * URL pattern for resolving namespaced components
   * The {name} placeholder will be replaced with the component name
   * @example "https://ishandev.vercel.app/r/{name}.json" resolves to "https://ishandev.vercel.app/r/component.json"
  ...
  namespaceUrl:
    ...
    "https://ishandev.vercel.app/r/{name}.json",
}
